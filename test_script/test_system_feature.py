...
class TestSystemFeature:
    ...
    def test_few_shot_conv(self, method, ll_method, ul_method, ll_objective, ul_objective,
        ...
        ul_model = bolv.utils.model.backbone.Conv([5, 3, 84, 84], 5, num_filters=32, use_head=False)
        ...
        optimizer.build_ll_solver(1 if ul_method == 'Onestage' else 5, ll_opt, truncate_iter=truncate_iter,
                                  alpha_init=alpha_init, alpha_decay=alpha_decay)
    ...
    def test_few_shot_res(self, method, ll_method, ul_method, ll_objective, ul_objective,
                           truncate_iter, truncate_max_loss_iter, alpha_init, alpha_decay,
                           update_ll_model_init):
        ul_model = bolv.utils.model.backbone.Res12([5, 3, 84, 84], 5, use_head=False)
    ...
    def test_regular(self, method, ll_method, ul_method, ll_objective, ul_objective,
                     truncate_iter, truncate_max_loss_iter, alpha_init, alpha_decay,
                     update_ll_model_init):
        ul_model = bolv.utils.model.backbone.Conv([32, 3, 84, 84], 8, num_filters=32, use_head=False)
